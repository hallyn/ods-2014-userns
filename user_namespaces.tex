...
\item Linux Kernel CVEs
  ...
  \item \href{http://www.cvedetails.com/vulnerability-list/vendor_id-33/product_id-47/year-2014/opgpriv-1/Linux-Linux-Kernel.html}{14} Priviledge Gain
  \end{itemize}
\item Use Cases
  \begin{itemize}
  \item run existing service in container: +1
  \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item \href{http://lwn.net/Articles/531114/}{'Namespaces In Operation' on lwn.net}
